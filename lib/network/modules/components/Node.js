...
class Node {
  ...
  setOptions(options) {
    ...
    Node.parseOptions(this.options, options, true, this.globalOptions, undefined);
  ...
  static updateGroupOptions(parentOptions, newOptions, groupList) {
   ...
   // var groupObj = groupList.get(group);
    ...
    util.selectiveNotDeepExtend(['font'], parentOptions, undefined);
  ...
  static parseOptions(parentOptions, newOptions, allowDeletion = false, globalOptions = {}, groupList) {
    ...
    Node.updateGroupOptions(parentOptions, newOptions, undefined);
